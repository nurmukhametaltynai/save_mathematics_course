...
BOT_TOKEN = "6344747701:AAHyXB8Hayex1pqwmlsKh_l--ySoRPv87Pk"
...
def callback_worker(call):
  if call.data == "yes":
    bot.send_message(call.message.chat.id, 'Отлично! Теперь я могу вас связаться если вам нужно.')
    a = call.message.text

    with open('user_date.txt', 'a') as file:
      file.write(f"{a} \n\n")
